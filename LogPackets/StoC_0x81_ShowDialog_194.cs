...
{
	[LogPacket(0x81, 194, ePacketDirection.ServerToClient, "Show dialog v194")]
	public class StoC_0x81_ShowDialog_194 : StoC_0x81_ShowDialog_186
	{
		public new NewQuestUpdate_194 InNewQuestUpdate		{ get { return subData as NewQuestUpdate_194; } }
		protected override void InitNewQuestUpdate()
		{
			subData = new NewQuestUpdate_194();
			subData.Init(this);
		}

		public class NewQuestUpdate_194: NewQuestUpdate_186
		{
			public ushort unk1_194;
		...
		public StoC_0x81_ShowDialog_194(int capacity) : base(capacity)
		{
		}
	}
}