...
namespace PacketLogConverter.LogPackets
{
	...
	public class StoC_0x08_HouseInsideUpdate : Packet, IOidPacket
	{
		...
		public override string GetPacketDataString(bool flagsDescription)
		{
			...
			str.AppendFormat("houseOid:0x{0:X4} heading:0x{1:X4} x:{2,-6} y:{3,-6} z:{4,-5} unk1:0x{5:X2} colorPorch:{6,-2} unk2:0x{7:X2} modelPorch:{8} emblem:0x{9:X4} modelHouse:{10} modelRoof:{11} modelWall:{12} modelDoor:{13} modelTruss:{14} materialPorch:{15} modelWindow:{16,-3}",
				houseOid, heading, x, y, z, unk1, colorPorch, unk2, modelPorch, emblem, modelHouse, modelRoof, modelWall, modelDoor, modelTruss, materialPorch, modelWindow);
