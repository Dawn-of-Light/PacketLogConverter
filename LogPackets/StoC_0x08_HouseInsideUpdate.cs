...
namespace PacketLogConverter.LogPackets
{
	...
	public class StoC_0x08_HouseInsideUpdate : Packet, IOidPacket
	{
		...
		public override string GetPacketDataString(bool flagsDescription)
		{
			...
			str.AppendFormat("houseOid:0x{0:X4} heading:0x{1:X4} x:{2,-6} y:{3,-6} z:{4,-5} banner&shield:{5:X4} emblem:0x{6:X4} unk1:0x{7:X4} modelHouse:{8} unk2:0x{9:X4} unk3:0x{10:X2} firstCarpet:{11,-3} secondCarpet:{12,-3} thirdCarpet:{13,-3} fourthCarpet:{14,-3} unk4:{15}",
