...
namespace PacketLogConverter.LogPackets
{
	...
	public class StoC_0x4B_PlayerCreate_172 : Packet, IObjectIdPacket, ISessionIdPacket
	{
		...
		{
			text.Write("sessionId:0x{0:X4} oid:0x{1:X4} model:0x{2:X4} zoneId:{3,-3} zoneLoc:({4,-5} {5,-5} {6,-5}) heading:0x{7:X4} eyeSize:0x{8:X2} lipSize:0x{9:X2} eyeColor:0x{10:X2} level:{11,-2} hairColor:0x{12:X2} faceType:0x{13:X2} hairStyle:0x{14:X2} flags:0x{15:X2} name:\"{16}\" guild:\"{17}\" lastName:\"{18}\" unk1:\"{19}\" trailingZero:{20}",
			...
			if (flagsDescription && flags != 0)
			{
				...
				text.Write("{0}{1}{2}{3}{4}", ((flags & 1) == 1) ? ", DEAD" : "", ((flags & 2) == 2) ? ", Underwater" : "", ((flags & 0x10) == 0x10) ? ", Stealth" : "", ((flags & 0x20) == 0x20) ? ", Wireframe" : "", ((flags & 0x40) == 0x40) ? ", BlueFace" : "", ((flags & 0x80) != 0) ? ", UNK:0x" + (flags & 0x80).ToString("X2") : "");
			}
		}
