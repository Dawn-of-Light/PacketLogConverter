...
namespace PacketLogConverter.LogPackets
{
	...
	public class CtoS_0x7D_UseSpellList_172 : CtoS_0x7D_UseSpellList
	{
		...
		public override string GetPacketDataString(bool flagsDescription)
		{
			...
			str.AppendFormat("flagSpeedData:0x{0:X4} heading:0x{1:X4} spellLevel:{2,-2} spellLineIndex:{3} playerZonePos({4,3}):({5,-6} {6,-6} {7,-5}) unk1:0x{8:X4} (speed:{9})",
				flagSpeedData, heading, spellLevel, spellLineIndex, currentZoneId, xOffsetInZone, yOffsetInZone, realZ, unk1, speed);
