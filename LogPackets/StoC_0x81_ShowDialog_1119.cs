...
{
    [LogPacket(0x81, 1119, ePacketDirection.ServerToClient, "Show dialog v1119")]
    public class StoC_0x81_ShowDialog_1119 : StoC_0x81_ShowDialog_1115
    {
        public new NewQuestUpdate_1119 InNewQuestUpdate { get { return subData as NewQuestUpdate_1119; } }
        protected override void InitNewQuestUpdate()
        {
            subData = new NewQuestUpdate_1119();
            subData.Init(this);
        }

        public class NewQuestUpdate_1119 : NewQuestUpdate_1115
        {
        ...
        public StoC_0x81_ShowDialog_1119(int capacity) : base(capacity)
        {
        }
    }
}
